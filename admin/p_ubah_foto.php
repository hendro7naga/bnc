...
?>
<noscript>
<div align="center"><a href="index.html">Kembali Ke Halaman Utama</a></div><!-- If javascript is disabled -->
</noscript>
<?php
//ini_set('display_errors', 1);
//error_reporting(E_ALL);
$namaku = $_POST['bncfoto'];
$id = $_POST['id'];
if(isset($_POST))
{
	 //Some Settings
	$ThumbSquareSize 		= 200; //Thumbnail will be 200x200
	$BigImageMaxSize 		= 240; //Image Maximum height or width
	...
	{
			die('Ada kesalahan dalam mengupload...!'); // output error when above checks fail.
	}
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		**/
		...
		$queris = "UPDATE t_menuinfo_bnc set foto_menu = '$NewImageName' WHERE namemenu = '".$_SESSION['login']."'";
		$h = $kontrol->db->insertData($queris);
		if(!$h)
			die("Gagal upload foto!"); 
		echo '<b><font face=Verdana size=2 color=red>Foto berhasil diganti...</font><br>';
		echo "<script type='text/javascript'> setTimeout('window.location.href = \"index\";', 1000); </script>";
