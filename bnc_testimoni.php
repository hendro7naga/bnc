    ...
    <div class="container content">
        <div class="row margin-bottom-30">
            <div class="col-md-9 mb-margin-bottom-30">
                <div class="headline"><h2>Form Testimoni</h2></div>
                <p>Silahkan isi form kontak dibawah ini untuk memberi testimoni Anda.</p>
                <form action="sfadfadsfab.bnc" method="post" class="sky-form sky-changes-3" id="bnc">
                    <fieldset>                  
                        <div class="row">
                            ...
                            <section class="col col-6">
                                <label class="label">E-mail <span>(Tidak di publish)</span></label>
                                <label class="input">
                        ...
                        <section>
                            <label class="label">Testimoni Anda (<span>Max: 255 Karakter</span>)</label>
                            <label class="textarea">
                                <i class="icon-append fa fa-comment"></i>
                                <textarea rows="4" name="message" id="message" maxlength="255"></textarea>
                            </label>
                        </section>
                    ...
                    <footer>
                        <button type="submit" class="btn-u">Kirim Testimoni</button>
                    </footer>
