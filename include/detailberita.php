...
?>
	...
	<div class="breadcrumbs">
	    <div class="container">
	        <h1 class="pull-left"><?php echo $kontrol->breadcrumbsNama($_GET['q']); ?></h1>
	        <ul class="pull-right breadcrumb">
	            <li><a href="index.html">Beranda</a></li>
	            <li class="active"><?php echo $kontrol->breadcrumbsNama($_GET['q']); ?></li>
	        </ul>
	    </div><!--/container-->
	</div><!--/breadcrumbs-->
	<!--=== End Breadcrumbs ===-->
    ...
    <div class="container content">		
    	<div class="row blog-page blog-item">
        	...
        	<div class="col-md-9 md-margin-bottom-60">
                ...
                if($_GET['q'] == "profil")
                {
                	echo $kontrol->getProfile($_GET['id']); 
                }
                elseif($_GET['q'] == "berita")
                {
                	echo $kontrol->getBerita($_GET['id']);
                }
                ?>
                <!--End Blog Post-->        
